...
export default function Feature22() {
    ...
    return (
        <div className="p-4 border border-slate-700 rounded-lg bg-slate-800">
            <h2 className="text-xl font-bold text-white mb-4">Network Feature Module 22</h2>
            {loading ? (
                <p className="text-slate-400">Loading metrics for module 22...</p>
            ) : (
